                ...
                <form method="post" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('judul_slider') is-invalid @enderror"
                            ...
                            value="{{ old('judul_slider') }}" data-bs-toggle="tooltip" data-bs-placement="top" />
                        @error('judul_slider')
                    ...
                    <div class="row g-2">
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" class="form-control @error('link_slider') is-invalid @enderror"
                                ...
                                value="{{ old('link_slider') }}" data-bs-toggle="tooltip" data-bs-placement="top" />
                            @error('link_slider')
                                <div class="invalid-feedback">
                                    Kolom wajib di isi.
                                </div>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <div class="col-sm-12">
                            <input type="file" class="form-control @error('foto_slider') is-invalid @enderror mb-3"
                    ...
                    <div class="col-12 mb-3 ">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gridCheck" name="is_aktif" value=1 />

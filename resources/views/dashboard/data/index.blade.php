...
<body>
                            ...
                            <div class="scroll-by-count" data-count="4">
                                    ...
                                    <div class="row g-0 sh-14 sh-md-10">
                                        ...
                                        <div class="col">
                                            <div class="card-body pt-0 pb-0 h-100">
                                                <div class="row g-0 h-100 align-content-center">
                                                    <div
                                                        class="col-12 col-md-9 d-flex align-items-center mb-2 mb-md-0">
                                ...
                                <div class="card mb-2">
                                    <div class="row g-0 sh-14 sh-md-10">
                                        <div class="col-auto">
                                            <a href="Products.Detail.html">
                                                <img src="img/product/small/product-8.webp" alt="alternate text"
                                                    class="card-img card-img-horizontal sw-11" />
                                            </a>
                                        </div>
                                        <div class="col">
                                    ...
                                    <div class="card-body mb-n2 scroll-out h-100">
                                        <div class="scroll h-100">
                                            ...
                                            <div class="row g-0 sh-10">
                                                <div class="col-auto">
                                                    <a href="Products.Detail.html">
                                                        <img src="img/product/small/product-10.webp"
                                                            class="card-img rounded-md h-100 sw-8" alt="thumb" />
                                                    </a>
                                                </div>
                                                <div class="col">
    ...
    <!-- Niches Modal Start -->
    <div class="modal fade modal-right scroll-out-negative" id="niches" data-bs-backdrop="true"
        tabindex="-1" role="dialog" aria-labelledby="niches" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable full" role="document">
            <div class="modal-content">
                <div class="modal-header">

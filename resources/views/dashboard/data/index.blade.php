                ...
                <table class="data-table data-table-pagination data-table-standard responsive nowrap"
                    ...
                    <tbody>
                        @foreach ($data as $data)
                            <tr>
                                <td>{{ $data->nama_budaya_kerja }}</td>
                                <td class="text-alternate">{{ $data->nama_buday_kerja }}</td>
                                <td class="text-alternate">
                                    <a class="btn btn-sm btn-icon btn-icon-only btn-outline-info"><i
                                            data-acorn-icon="eye"></i></a>
                                    <a class="btn btn-sm btn-icon btn-icon-only btn-outline-warning"><i

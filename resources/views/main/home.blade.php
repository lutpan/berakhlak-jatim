...
<body>
    <div class="page-wrapper">
                ...
                <div class="container-fluid clearfix">
                    ...
                    <div class="header-inner d-flex align-items-center">
                        <div class="logo-outer d-flex align-items-center">
                            <div class="logo col-1"><a href=""><img
                                        src="landing-page/assets/images/jatim-logo.png" alt="Logo"
                                        title="Logo"></a></div>
                            <div class="col">
        ...
        <section class="hero-section rel z-1 bg-lighter" id="home">
            ...
            <img class="circle-shape" src="landing-page/assets/images/shapes/circle.png" alt="Shape">
            <img class="half-circle-shape" src="landing-page/assets/images/shapes/half-circle.png" alt="Shape">
            <img class="rectangle-shape" src="landing-page/assets/images/shapes/rectangle.png" alt="Shape">
        </section>
        <!-- Hero Section End -->

        <!-- Pricing Section Start -->
        <section class="pricing-section pt-135 rpt-95 mb-180 rel z-0 bg-lighter" id="about">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-image rmb-65 wow fadeInLeft delay-0-2s">
                            <img src="landing-page/assets/images/about/aobut.png" alt="About">
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-end">
                        <div class="features-image text-lg-right wow fadeInLeft delay-0-2s">
                            <img src="landing-page/assets/images/services/feature.png" alt="Features">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="solution-image rmb-65 wow fadeInLeft delay-0-2s">
                            <img src="landing-page/assets/images/about/solution.png" alt="Solution">
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container" id="content">
                <div class="row justify-content-between align-items-center pb-45">
                    <div class="col-xl-7 col-lg-8">
                        <div class="section-title mb-25">
                            <span class="sub-title mb-15">Studi Kasus</span>
                            <h2><span>Budaya Kerja</span></h2>
                        </div>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="portfolio-wrap">
                @foreach ($content as $content)
                    <div class="portfolio-item wow fadeInUp delay-0-2s">
                        <img src="landing-page/assets/images/portfolios/portfolio1.jpg" alt="Portfolio">
                        <a class="portfolio-hover" href="portfolio-details.html">
                            <div class="content">
                                <span class="category">{{ $content->id_user }}</span><br>
                                <span class="category">{{ $content->id_kategori }}</span>
                                <h4>{{ $content->nama_budaya_kerja }}</h4>
                            </div>
                ...
                <div class="portfolio-item wow fadeInUp delay-0-4s">
                    <img src="landing-page/assets/images/portfolios/portfolio3.jpg" alt="Portfolio">
                    <a class="portfolio-hover" href="portfolio-details.html">
                        <div class="content">
                            <span class="category">Design Team</span>
                            <h4>Web design Consulthing</h4>
                ...
                <div class="portfolio-item wow fadeInUp delay-0-5s">
                    <img src="landing-page/assets/images/portfolios/portfolio4.jpg" alt="Portfolio">
                    <a class="portfolio-hover" href="portfolio-details.html">
                        <div class="content">
                            <span class="category">Design Team</span>
                            <h4>Web design Consulthing</h4>
                ...
                <div class="portfolio-item wow fadeInUp delay-0-6s">
                    <img src="landing-page/assets/images/portfolios/portfolio5.jpg" alt="Portfolio">
                    <a class="portfolio-hover" href="portfolio-details.html">
                        <div class="content">
                            <span class="category">Design Team</span>
                            <h4>Web design Consulthing</h4>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-2s">
                            <img src="landing-page/assets/images/team/team-member1.jpg" alt="Team Member">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-4s">
                            <img src="landing-page/assets/images/team/team-member2.jpg" alt="Team Member">
                            <div class="member-description">
                                <div class="social-area">
                                    <div class="social-icons">
                                        <a href="contact.html"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-6s">
                            <img src="landing-page/assets/images/team/team-member3.jpg" alt="Team Member">
                            <div class="member-description">
                                <div class="social-area">
                                    <div class="social-icons">
                                        <a href="contact.html"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-8s">
                            <img src="landing-page/assets/images/team/team-member4.jpg" alt="Team Member">
                            <div class="member-description">
                                <div class="social-area">
                                    <div class="social-icons">
                                        <a href="contact.html"><i class="fab fa-twitter"></i></a>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="testimonial-left-content rel z-1 rmb-50 wow fadeInUp delay-0-2s">
                            ...
                            <img class="rectangle-shape" src="landing-page/assets/images/shapes/rectangle.png"
                                alt="Shape">
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item wow fadeInUp delay-0-4s">
                                ...
                                <div class="testimonial-author">
                                    <div class="image">
                                        <img src="landing-page/assets/images/testimonials/author1.jpg"
                                            alt="Testimonial">
                                    </div>
                                    <div class="content">
                                        <h5>Al Mahmud</h5>
                            ...
                            <div class="testimonial-item wow fadeInUp delay-0-6s">
                                ...
                                <div class="testimonial-author">
                                    <div class="image">
                                        <img src="landing-page/assets/images/testimonials/author2.jpg"
                                            alt="Testimonial">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="row align-itmes-center">
                        ...
                        <div class="col-lg-6">
                            <div class="subscribe-form mt-10 wow fadeInRight delay-0-2s">
                                ...
                                <img src="landing-page/assets/images/shapes/hand.png" alt="hand" class="hand">
                            </div>
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget about-widget">
                            ...
                            <div class="footer-contact mt-30">
                                ...
                                <a href="mailto:info@telco.com">info@telco.com</a>
                            </div>
                        </div>
                    </div>
